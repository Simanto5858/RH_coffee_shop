...
<body>
    <div id="wrapper">
        <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="<?php echo ADMINURL; ?>">RH Coffee Shop <small>Delicious Taste</small></a>
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <?php if (isset($_SESSION['admin_name'])) { ?>
                        <ul class="navbar-nav side-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo ADMINURL; ?>/contact-messages.php"><i class="fa fa-envelope"></i> <span class="ml-3">Messages</span> <?php if (isset($contact_messages_count) && $contact_messages_count['count'] > 0): ?><span class="badge badge-warning ml-2"><?php echo $contact_messages_count['count']; ?></span> <?php endif; ?></a>
                            </li>
                        </ul>
                    <?php  } ?>
