    ...
    <div class="row mb-5">
      <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
        <div class="ftco-footer-widget mb-4">
          ...
          <p>
            Serving perfection in every cup of coffee using the finest ingredients and creating an environment where everyone feels welcome.

We ethically source and hand-roast each of our coffee beans, so you can experience the purest flavor and freshness in every sip.
          </p>
          <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
            <li class="ftco-animate">
              <a href="https://web.telegram.org/a/"><span class="icon-telegram"></span></a>
            </li>
            <li class="ftco-animate">
      ...
      <div class="col-lg-4 col-md-6 mb-5 mb-md-5">
        <div class="ftco-footer-widget mb-4">
          ...
          <div class="block-21 mb-4 d-flex">
            ...
            <div class="text">
              <h3 class="heading">
                <a href="http://localhost/RH-coffee-shop/menu.php">Even the all-powerful Pointing has no control about</a>
              </h3>
              <div class="meta">
                <div>
                  <a href="#"><span class="icon-calendar"></span> Sept 15, 2025</a>
                </div>
                <div>
      ...
      <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
        <div class="ftco-footer-widget mb-4">
          ...
          <div class="block-23 mb-3">
            <ul>
              <li>
                <span class="icon icon-map-marker"></span><span class="text">203  St. , Feni Sadar, Feni, Bangladesh
                  </span>
              </li>
              <li>
                <a href="#"><span class="icon icon-phone"></span><span class="text">0187*******</span></a>
              </li>
              <li>
                <a href="#"><span class="icon icon-envelope"></span><span class="text">simanto5858@gmail.com</span></a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        <p>
          ...
          <i class="icon-heart" aria-hidden="true"></i> by Ratul Hossain 
        </p>
      </div>
    </div>
  </div>
